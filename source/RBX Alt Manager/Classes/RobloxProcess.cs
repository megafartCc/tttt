...
namespace RBX_Alt_Manager.Classes
{
    internal class RobloxProcess
    {
        ...
        private static readonly Regex BrowserTrackerRegex = new Regex(@"(?:\-b\s+|browsertrackerid[:=])(\d+)", RegexOptions.IgnoreCase);
        ...
        public RobloxProcess(Process process)
        {
            ...
            try
            {
                Match trackerMatch = BrowserTrackerRegex.Match(RbxProcess.GetCommandLine() ?? string.Empty);
